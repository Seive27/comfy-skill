...
declare -A SKILLS=(
  [comfy-skill]="skills/comfy-skill/SKILL.md"
  [comfy-skill-v1]="skills/comfy-skill-v1/SKILL.md"
  [gpt-comfy]="skills/gpt-comfyskill/SKILL.md"
  ...
  [neo-brutalism-skill]="skills/neo-brutalism-skill/SKILL.md"
)
